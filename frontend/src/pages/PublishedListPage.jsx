...
export default function PublishedListPage() {
  ...
  const handleArchive = async (tutorialId) => {
    setOpenDropdownId(null);
    try {
  ...
  const handleUnpublish = async (tutorialId) => {
    setOpenDropdownId(null);
    // TODO: Implement unpublish functionality
    console.log("Unpublish tutorial:", tutorialId);
  };

  const handlePreview = (tutorialId) => {
    setOpenDropdownId(null);
    // TODO: Implement preview functionality
    console.log("Preview tutorial:", tutorialId);
  };
    ...
    <div style={styles.container}>
      <header style={styles.header}>
        <div style={styles.headerTop}>
          <h1 style={styles.title}>Published Tutorials</h1>
              ...
              <div style={styles.actionsContainer} ref={openDropdownId === t.tutorialId ? dropdownRef : null}>
                ...
                {openDropdownId === t.tutorialId && (
                  <div style={styles.dropdownMenu}>
                    ...
                    <button
                      style={styles.dropdownItem}
                      onClick={() => handleUnpublish(t.tutorialId)}
                    >
                      Unpublish
                    </button>
                    <button
                      style={styles.dropdownItem}
                      onClick={() => handleArchive(t.tutorialId)}
                    >
                      Archive
                    </button>
                    <button
                      style={styles.dropdownItem}
                      onClick={() => handlePreview(t.tutorialId)}
                    >
                      Preview
                    </button>
                  </div>
